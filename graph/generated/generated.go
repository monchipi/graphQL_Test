...
type MutationResolver interface {
	...
	DoneTodo(ctx context.Context, id int) (*models.Todo, error)
}
...
`, BuiltIn: false},
	{Name: "../../schema/types/todo.graphql", Input: `type Todo @goModel(model: "github.com/monchipi/ex-myserver/models.Todo"){
    id: ID!
    text: String!
    isCompleted: Boolean!
}

input NewTodo @goModel(model: "github.com/monchipi/ex-myserver/models.NewTodo"){
    Text: String!
    UserId: String!
}
...
func (ec *executionContext) field_Mutation_CreateTodo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewTodo2githubᚗcomᚋmonchipiᚋexᚑmyserverᚋmodelsᚐNewTodo(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_CreateTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNTodo2ᚖgithubᚗcomᚋmonchipiᚋexᚑmyserverᚋmodelsᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_DoneTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DoneTodo(rctx, fc.Args["id"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*models.Todo)
	fc.Result = res
	return ec.marshalNTodo2ᚕᚖgithubᚗcomᚋmonchipiᚋexᚑmyserverᚋmodelsᚐTodoᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Todo_isCompleted(ctx context.Context, field graphql.CollectedField, obj *models.Todo) (ret graphql.Marshaler) {
...
func (ec *executionContext) unmarshalNNewTodo2githubᚗcomᚋmonchipiᚋexᚑmyserverᚋmodelsᚐNewTodo(ctx context.Context, v interface{}) (models.NewTodo, error) {
...
func (ec *executionContext) marshalNTodo2githubᚗcomᚋmonchipiᚋexᚑmyserverᚋmodelsᚐTodo(ctx context.Context, sel ast.SelectionSet, v models.Todo) graphql.Marshaler {
	return ec._Todo(ctx, sel, &v)
}

func (ec *executionContext) marshalNTodo2ᚕᚖgithubᚗcomᚋmonchipiᚋexᚑmyserverᚋmodelsᚐTodoᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Todo) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTodo2ᚖgithubᚗcomᚋmonchipiᚋexᚑmyserverᚋmodelsᚐTodo(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNTodo2ᚖgithubᚗcomᚋmonchipiᚋexᚑmyserverᚋmodelsᚐTodo(ctx context.Context, sel ast.SelectionSet, v *models.Todo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
